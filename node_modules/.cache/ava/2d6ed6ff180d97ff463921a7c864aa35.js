...
test('listPicture', async t => {
  ...
  let imagen = fixtures.getImagenes();

  imagen.liked = true;
  imagen.likes = 1;

  nock(options.endpoints.pictures).get('/list').reply(200, imagen);

  let result = await client.listPicture(imagen.publicId);

  t.deepEqual(imagen, result);
});
//# sourceMappingURL=..\node_modules\.cache\ava\2d6ed6ff180d97ff463921a7c864aa35.js.map