...
test('autenticacion', async t => {
  ...
  nock(options.endpoints.auth).post('/', credenciales).reply(200, token);

  let result = await client.auth(credenciales.username, credenciales.password);

  t.deepEqual(token, result);
});
//# sourceMappingURL=..\node_modules\.cache\ava\e8674ac9fb827352a62040cc3c2ec207.js.map